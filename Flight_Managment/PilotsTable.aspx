<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="PilotsTable.aspx.cs" Inherits="Flight_Managment.WebForm5" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <span class="sr-only">Loading...</span>
    ...
    <iframe name="iframe" src="IframePilots.aspx" align="center" scrolling="no" style="border:none; width:100vw;height:80%; overflow:hidden;margin-left:-8vw;margin-right:1vw;margin-bottom:-20px;margin-top:-6vh;
" >
     </iframe> 
