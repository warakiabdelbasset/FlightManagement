...
namespace Flight_Managment.Login_v3.Login_v3
{
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            using (SqlConnection sqlCon = new SqlConnection(connectionString))
            {
                ...
                if (sdr.Read())
                {
                    ...
                    Session["prenom"] = sdr["prenom_user"].ToString();
                    Session["email"] = sdr["email_user"].ToString();
                ...
                if (sdr1.Read())
                {
                    ...
                    Session["prenom"] = sdr1["prenom_user"].ToString();
                    Session["email"] = sdr1["email_user"].ToString();
                    Session["id"] = sdr1["num_user"].ToString();
                    Response.Redirect("First_Page/Regestration_Form/Reservation_Form.aspx");
