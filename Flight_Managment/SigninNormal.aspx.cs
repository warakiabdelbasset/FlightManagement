...
{
    public partial class SigninNormal : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                using (SqlConnection sqlCon = new SqlConnection(connectionString))
                {
                    ...
                    sqlCmd.Parameters.AddWithValue("@nom_user", TextBox3.Text.Trim());
                    sqlCmd.Parameters.AddWithValue("@prenom_user", TextBox3.Text.Trim());
                    sqlCmd.Parameters.AddWithValue("@tel_user", TextBox3.Text.Trim());
                    sqlCmd.Parameters.AddWithValue("@email_user", TextBox3.Text.Trim());
                    sqlCmd.Parameters.AddWithValue("@mdp_user", Encrypt(TextBox2.Text.Trim()));
