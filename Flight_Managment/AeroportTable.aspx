<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AeroportTable.aspx.cs" Inherits="Flight_Managment.WebForm6" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <div style="margin-left:-2vw;margin-right:-2vw; margin-bottom:10vh; margin-top:5vh;">
  ...
  <span class="sr-only">Loading...</span>
    ...
    <iframe name="iframe" src="IframeAeroport.aspx" align="center" scrolling="no" style="border:none; width:100vw;height:80%; overflow:hidden;margin-left:-8vw;margin-right:1vw;margin-bottom:-20px;margin-top:-6vh;
" >
     </iframe> 
