<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IframePilots.aspx.cs" Inherits="Flight_Managment.IframePilots" %>
...
<body>
    ...
    <div class=" waves-effect waves-block waves-light">
          <div align="center">
            ...
            <asp:GridView CssClass="boxsha" ID="gvPhoneBook" runat="server"  AutoGenerateColumns="False" ShowFooter="True" DataKeyNames="num_pil"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="#" HeaderStyle-Height="60px" ItemStyle-CssClass="center">
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("num_pil") %>' runat="server" align="center" />
                        </ItemTemplate>
                        <EditItemTemplate>
                        </EditItemTemplate>
                        <FooterTemplate>
                    ...
                    <asp:TemplateField ItemStyle-CssClass="center" HeaderStyle-CssClass="center" HeaderText="First Name" >
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("nom_pil") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtFirstName" Text='<%# Eval("nom_pil") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                    ...
                    <asp:TemplateField HeaderText="Last Name" HeaderStyle-CssClass="center" ItemStyle-CssClass="center">
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("prenom_pil") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtLastName" Text='<%# Eval("prenom_pil") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                    ...
                    <asp:TemplateField HeaderText="Contact" HeaderStyle-CssClass="center" ItemStyle-CssClass="center">
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("tel_pil") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtContact" Text='<%# Eval("tel_pil") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                    ...
                    <asp:TemplateField HeaderText="Email" HeaderStyle-CssClass="center" ItemStyle-CssClass="center">
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("email_pil") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtEmail" Text='<%# Eval("email_pil") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
