<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IframeClient.aspx.cs" Inherits="Flight_Managment.trst" %>
            ...
            <asp:GridView CssClass="boxsha" ID="gvPhoneBook" runat="server"  AutoGenerateColumns="False" ShowFooter="True" DataKeyNames="num_user"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Email" HeaderStyle-CssClass="center" ItemStyle-CssClass="center">
                        <ItemTemplate>
                            <asp:Label ID="label" Text='<%# Eval("email_user") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                     ...
                     <asp:TemplateField HeaderText="Password" HeaderStyle-CssClass="center" ItemStyle-CssClass="center">
                        <ItemTemplate>
